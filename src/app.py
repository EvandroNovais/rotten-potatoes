...
app.config['MONGODB_DB'] = os.getenv("MONGODB_DB", ${"value"})
app.config['MONGODB_HOST'] = os.getenv("MONGODB_HOST", ${"value"})
app.config['MONGODB_PORT'] = int(os.getenv("MONGODB_PORT", ${"value"}))
app.config['MONGODB_USERNAME'] = os.getenv("MONGODB_USERNAME", ${"value"})
app.config['MONGODB_PASSWORD'] = os.getenv("MONGODB_PASSWORD", ${"value"}) 
